package br.com.boasaude.cadastro.prestador.application.prestador.dto.response.v1;
...
public class PrestadorResponse {
	...
	@ApiModelProperty(notes = "Id do prestador",name="id",required=true,value="Teste Id")
	private Long id;
